...
function SubmitButton({ text, hasSelectedRecommendationType, hasSelectedAnyPreferenceOrFeature }) {
  return (
    <div className="bg-white rounded-md shadow-md p-4 flex flex-col gap-4">
      ...
      <button
        type="submit"
        disabled={!hasSelectedRecommendationType || !hasSelectedAnyPreferenceOrFeature}
